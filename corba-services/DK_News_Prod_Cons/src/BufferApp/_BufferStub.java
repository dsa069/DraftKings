...
public class _BufferStub extends org.omg.CORBA.portable.ObjectImpl implements BufferApp.Buffer {
    ...
    public String[] obtener_todas() {
        org.omg.CORBA.portable.InputStream $in = null;
        try {
            org.omg.CORBA.portable.OutputStream $out = _request("obtener_todas", true);
            $in = _invoke($out);
            String[] $result = null;
            int $resultSize = $in.read_long();
            $result = new String[$resultSize];
            for (int $i0 = 0; $i0 < $resultSize; ++$i0)
                $result[$i0] = $in.read_string();
            return $result;
        } catch (org.omg.CORBA.portable.ApplicationException $ex) {
            $in = $ex.getInputStream();
            String _id = $ex.getId();
    ...
    public boolean read_en(int indice, org.omg.CORBA.StringHolder elemento) {
        org.omg.CORBA.portable.InputStream $in = null;
        try {
            org.omg.CORBA.portable.OutputStream $out = _request("read_en", true);
            $out.write_long(indice);
            $in = _invoke($out);
            boolean $result = $in.read_boolean();
            elemento.value = $in.read_string();
            return $result;
            ...
            return read_en(indice, elemento);
        } finally {
            _releaseReply($in);
        }
    } // read_en
