...
GOOGLE_APPLICATION_CREDENTIALS="$PWD/credentials/gc-dk.json" terraform workspace select dev || GOOGLE_APPLICATION_CREDENTIALS="$PWD/credentials/gc-dk.json" terraform workspace new dev
...
GOOGLE_APPLICATION_CREDENTIALS="$PWD/credentials/gc-dk.json" terraform destroy \
  ...
  -var="machine_name=dk-corba-dev-vm-tf" \
